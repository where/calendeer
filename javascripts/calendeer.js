$(function(){
  ...
  $.extend( Calendeer.prototype, {
    ...
    setupTimeInput: function( type, input ) {
      ...
      $input.on( "change.calendeer." + type + " keyup.calendeer." + type, { type: type, scope: this }, this.inputTimeHandler );
    ...
    setupInput: function( type, input ) {
      ...
      $input.on( "change.calendeer." + type + " keyup.calendeer." + type, { type: type, scope: this }, this.inputHandler );
      $input.on( "focus.calendeer." + type, { type: type, scope: this }, $.proxy( function(e) {
